  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <section className="relative h-screen min-h-[600px] flex items-center justify-center overflow-hidden">
        {/* Hero Background - Unsplash: Spices market colorful */}
        ...
        <div className="container-padding relative z-10 text-center text-white max-w-4xl pt-20">
          <motion.div
            initial="hidden"
            animate="visible"
          ...
          >
            ...
            <motion.h1 variants={fadeIn} className="font-display text-4xl md:text-6xl lg:text-7xl font-bold leading-tight mb-6 text-shadow">
              ...
              <span className="text-primary-foreground">Delivered Globally.</span>
            </motion.h1>
