      ...
      <div className="bg-secondary text-white pt-32 pb-20">
        <div className="container-padding text-center">
          ...
          <p className="text-white/70 max-w-2xl mx-auto text-lg">
            Have questions about our products or want a custom quote? We'd love to hear from you.
          </p>
        </div>
      </div>
              ...
              <ul className="space-y-6">
                <li className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-lg">+91 987 654 3210</p>
                  </div>
                </li>
                <li className="flex items-start gap-4">
                  <div className="bg-white/10 p-2 rounded-lg mt-1">
                  ...
                  <div>
                    ...
                    <p className="text-lg break-all">export@zakainternational.com</p>
                  </div>
                </li>
                <li className="flex items-start gap-4">
                  <div className="bg-white/10 p-2 rounded-lg mt-1">
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormControl>
                          <Input placeholder="John Doe" {...field} className="bg-muted/30 border-muted-foreground/20 focus-visible:ring-primary" />
                        </FormControl>
                        <FormMessage />
                      </FormItem>
                    )}
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormControl>
                          <Input placeholder="Your Business Ltd." {...field} className="bg-muted/30 border-muted-foreground/20 focus-visible:ring-primary" value={field.value || ''} />
                        </FormControl>
                        <FormMessage />
                      </FormItem>
                    )}
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Input type="email" placeholder="john@company.com" {...field} className="bg-muted/30 border-muted-foreground/20 focus-visible:ring-primary" />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
