      ...
      <div className="bg-secondary text-white pt-32 pb-20">
        <div className="container-padding">
          ...
          <p className="text-xl text-white/80 max-w-2xl font-light">
            We are dedicated to delivering the finest flavors of India to every
            corner of the globe.
          </p>
        </div>
      </div>
          ...
          <div className="space-y-8">
            <div>
              ...
              <p className="text-muted-foreground leading-relaxed text-lg">
                Founded with a vision to bridge the gap between Indian farmers
                and international markets, Zaka International has established
                itself as a premier name in the spice export industry. What
                started as a small trading house has now grown into a global
                supply chain network, trusted by wholesalers and food industries
                worldwide.
              </p>
            </div>
            ...
            <div>
              ...
              <p className="text-muted-foreground leading-relaxed text-lg">
                To promote Indian agriculture by providing fair value to farmers
                while ensuring our global clients receive products that meet the
                highest standards of purity, safety, and quality.
              </p>
            </div>
